...
var proxyTcfApi = function proxyTcfApi(_) {
  if (videojs.dom.isInFrame() && typeof window$1.__tcfapi !== 'function') {
    var frame = window$1;
    var cmpFrame;
    var cmpCallbacks = {};
    ...
    window$1.__tcfapi = function (cmd, version, callback, arg) {
    ...
    window$1.addEventListener('message', function (event) {
      var json = {};
...
var listenToTcf = function listenToTcf() {
  ...
  if (typeof window$1.__tcfapi === 'function') {
    window$1.__tcfapi('addEventListener', 2, function (data, success) {
      if (success) {
        tcData = data;
      }
    });
...
function adMacroReplacement(string, uriEncode, customMacros) {
  ...
  macros['{player.pageUrl}'] = videojs.dom.isInFrame() ? document$1.referrer : window$1.location.href;
  ...
  macros['{window.location.href}'] = window$1.location.href;
...
var contribAdsPlugin = function contribAdsPlugin(options) {
  ...
  var settings = videojs.mergeOptions(defaults$1, options); // Prefix all video element events during ad playback
...
export { vastWaterfall as default };
